...
class SwitchMultiAccessory extends SwitchAccessory {
  ...
  setupServiceManager () {
    ...
    setTimeout(() => {
      log(`\x1b[33m[Warning] \x1b[33m[${name}]\x1b[0m: The "switch-multi-repeat" accessory is now deprecated and shall be removed in the future. Check out the updated "switch" documentation at http://github.com/lprhodes/homebridge-broadlink-rm`);
    }, 1600)
